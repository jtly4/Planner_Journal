...
function MyForm() {
    ...
    return (
        ...
        <label className='help_label'>Email Adress:</label><br />
        <input 
        ...
        /><br/>
        <label className='help_label'> Subject:</label><br />
        <input 
            className='help_input'
            type="text" 
            name="subject" 
            ...
            onChange={handleChange}
        /><br />
        <label className='help_label'>Message:</label><br />
        <textarea 
            className='help_input'
            id = "help_message"
            type="text" 
            ...
            onChange={handleChange}
        /><br />
            <input type="submit" id="help-submit-btn"/>
        </form>
    )
}
